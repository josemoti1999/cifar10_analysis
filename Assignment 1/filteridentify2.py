if __name__=='__main__':
    ...
    def test_4(testloader, model):
            ...
            with torch.no_grad():
                ...
                for data in tqdm(testloader):
                    ...
                    for i in range(labels.size(0)):
                        ...
                        max_value=np.asscalar(max_value)
            ...
            print('Accuracy of the network on the 10000 test images: %d %%' % (
                                            100 * correct / total))
            a=100*correct/total
            return a, find_labels, find_change, find_pred, mv
    ...
    #net.conv1.weight.data[0:2,:,:,:]=0
    #net.conv2.weight.data[1:64,:,:,:]=0
    #net.conv2.weight.data[0:2,:,:,:]=0
    #net.conv3.weight.data[4:256,:,:,:]=0
    #net.conv3.weight.data[0:3,:,:,:]=0        
    
    net.eval().cuda()
    #a=test_check(testloader,net)
    (a2,find_labels_2,find_change_2, find_pred_2, mv_2)=test_4(testloader,net)
    mv_index_2=sorted(range(len(mv_2)),reverse=True, key=lambda k: mv_2[k])
    print(mv_2)
    print(mv_index_2)
